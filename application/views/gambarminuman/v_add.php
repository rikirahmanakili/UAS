<div class="col-md-12">
	<div class="card card-primary">
		<div class="card-header">
			<h3 class="card-title">Add Gambar Minuman : <?= $minuman->nama_minuman ?></h3>
		...
		<div class="card-body">
			...
			echo form_open_multipart('gambarminuman/add/' . $minuman->id_minuman) ?>
			...
			<div class="form-group">
				...
				<a href="<?= base_url('gambarminuman') ?>" class="btn btn-success btn-sm">Kembali</a>
			</div>
			...
			<div class="row">
				<?php foreach ($gambar as $key => $value) { ?>
					<div class="col-sm-3">
						<div class="form-group">
							<img src="<?= base_url('assets/gambarminuman/' . $value->gambar) ?>" id="gambar_load" width="250px" height="200px">
						</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer justify-content-between">
					...
					<a href="<?= base_url('gambarminuman/delete/' . $value->id_minuman . '/' . $value->id_gambar) ?>" class="btn btn-primary">Delete</a>
				</div>
