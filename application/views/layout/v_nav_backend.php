...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<div class="sidebar">
		...
		<div class="user-panel mt-3 pb-3 mb-3 d-flex">
			<div class="image">
				<img src="<?= base_url() ?>template/dist/img/kisara.jpg" class="img-circle elevation-2" alt="User Image">
			</div>
			<div class="info">
		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
			   ...
			   with font-awesome or any other icon font library -->
				...
				<li class="nav-item">
					<a href="<?= base_url('minuman')  ?>" class="nav-link <?php if ($this->uri->segment(1) == 'minuman') {
																				echo "active";
																			} ?>">
				...
				<li class="nav-item">
					<a href="<?= base_url('gambarminuman')  ?>" class="nav-link <?php if ($this->uri->segment(1) == 'gambarminuman') {
																					echo "active";
																				} ?>">
